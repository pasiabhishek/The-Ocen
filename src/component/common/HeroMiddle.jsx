...
function HeroMiddle() {
  return (
    ...
    >
      ...
      <h5 className=' sm:text-base md:text-1xl  w-full mb-3 text-sm font-semibold uppercase tracking-[0.3em] hover:text-1.2xl hover:text-[#0099ff]'>
        The ocean is life
      </h5>

      <h1 className=' sm:text-4xl leading-tight w-full text-4xl font-bold text-white md:text-6xl'>
        Deeper Than <span className='text-[#0099ff]'>You Imagine</span>
      </h1>

      <p className='text-xs sm:text-sm md:text-[15px] sm:mt-4 md:mt-5 px-2 sm:px-6 md:pl-10 md:pr-10 font-light leading-relaxed w-full mt-4 max-w-xl text-white/60'>
