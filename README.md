...
- **Ocean-themed preload screen** — a bubble-and-spinner loader that greets visitors while the page settles, then slides away with a GSAP wipe
...
│   │   │   ├── Loader.jsx               # Full-screen ocean loader shown on page load
